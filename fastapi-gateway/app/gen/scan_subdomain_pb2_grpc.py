...
class SubdomainScannerStub(object):
    """service definition
    """
...
def add_SubdomainScannerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'scan_domain.SubdomainScanner', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('scan_domain.SubdomainScanner', rpc_method_handlers)
