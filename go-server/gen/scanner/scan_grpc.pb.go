...
const (
	ScanService_RunTool_FullMethodName = "/scanner.ScanService/RunTool"
)
...
type ScanServiceClient interface {
	// RunTool return scanned results indentified by `target` and `tool_name`
	// return ScanResponse with scanned results details
	RunTool(ctx context.Context, in *ScanRequest, opts ...grpc.CallOption) (*ScanResponse, error)
}
...
func (c *scanServiceClient) RunTool(ctx context.Context, in *ScanRequest, opts ...grpc.CallOption) (*ScanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScanResponse)
	err := c.cc.Invoke(ctx, ScanService_RunTool_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ScanServiceServer interface {
	// RunTool return scanned results indentified by `target` and `tool_name`
	// return ScanResponse with scanned results details
	RunTool(context.Context, *ScanRequest) (*ScanResponse, error)
...
func (UnimplementedScanServiceServer) RunTool(context.Context, *ScanRequest) (*ScanResponse, error) {
...
func _ScanService_RunTool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ScanServiceServer).RunTool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ScanService_RunTool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScanServiceServer).RunTool(ctx, req.(*ScanRequest))
	}
...
var ScanService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "scanner.ScanService",
	HandlerType: (*ScanServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RunTool",
			Handler:    _ScanService_RunTool_Handler,
		},
	},
